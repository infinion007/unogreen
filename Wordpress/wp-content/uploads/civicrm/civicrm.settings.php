...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/wordpress?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://localhost/wordpress/';
$civicrm_paths['wp.backend.base']['url'] = 'http://localhost/wordpress/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'http://localhost/wordpress/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/wordpress?new_link=true');
  }
}
...
$civicrm_root = 'C:\\xampp\\htdocs\\Wordpress\\wp-content\\plugins\\civicrm/civicrm\\';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\\xampp\\htdocs\\Wordpress/wp-content/uploads\\civicrm\\templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'vNdedEBWtBZRLn2PbN7UpZ66IFbuwR521NRGg3NEfeU');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\\xampp\\htdocs\\Wordpress/wp-content/uploads\\civicrm\\templates_c/mail.log');
// }
