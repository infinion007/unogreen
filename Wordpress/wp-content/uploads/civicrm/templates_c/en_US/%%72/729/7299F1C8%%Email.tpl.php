...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Edit/Email.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Edit/Email.tpl', 16, false),array('function', 'help', 'CRM/Contact/Form/Edit/Email.tpl', 20, false),array('modifier', 'crmAddClass', 'CRM/Contact/Form/Edit/Email.tpl', 28, false),)), $this); ?>
...
<br/><?php echo $this->_tpl_vars['form']['email'][$this->_tpl_vars['blockId']]['signature_text']['html']; ?>
  ...
  <td align="center" id="Email-Primary-html" <?php if ($this->_tpl_vars['blockId'] == 1): ?>class="hiddenElement"<?php endif; ?>>
    <?php echo $this->_tpl_vars['form']['email'][$this->_tpl_vars['blockId']]['is_primary']['1']['html']; ?>
