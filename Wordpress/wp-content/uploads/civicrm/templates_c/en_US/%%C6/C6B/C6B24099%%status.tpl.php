...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/status.tpl', 1, false),array('modifier', 'json_encode', 'CRM/common/status.tpl', 20, false),)), $this); ?>
...
?>
    <?php if ($this->_tpl_vars['urlIsPublic']): ?>
      <?php $this->assign('infoType', "no-popup ".($this->_tpl_vars['statItem']['type'])); ?>
    <?php else: ?>
