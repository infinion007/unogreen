<?php /* Smarty version 2.6.31, created on 2021-01-16 07:36:29
         compiled from CRM/Contact/Form/ShareAddress.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/ShareAddress.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/ShareAddress.tpl', 113, false),array('function', 'help', 'CRM/Contact/Form/ShareAddress.tpl', 13, false),array('modifier', 'json_encode', 'CRM/Contact/Form/ShareAddress.tpl', 41, false),)), $this); ?>
...
" class="form-layout-compressed">
      ...
      <div class="shared-address-add-relationship" style="display: none;">
        <?php echo $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']]['add_relationship']['html']; ?>

        <?php echo $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']]['add_relationship']['label']; ?>

        <span class="employer"><?php echo smarty_function_help(array('id' => "id-sharedAddress-updateRelationships",'file' => "CRM/Contact/Form/Contact"), $this);?>
</span>
      </div>
      ...
      $.post(CRM.url(\'civicrm/ajax/inline\'), {
        ...
        function(response) {
          ...
          if (response && $el.val() === sharedContactId) {
            ...
            if (!addressHTML) {
              addressHTML = '; ?>
"<?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Selected contact does not have an address. Please click the following link to edit that contact to add an address, or select a different contact.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"<?php echo ' + \' <a target="_blank" href="\' + CRM.url(\'civicrm/contact/add\', \'reset=1&action=update&cid=\' + sharedContactId) + \'">'; ?>
<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Edit Contact Details<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '</a>\';
            }
