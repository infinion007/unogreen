<!doctype html>
 <table width="600" border="0" cellpadding="15" cellspacing="0" style="width:600px; margin:0px auto; height:auto; border:1px solid #a1a1a1" >
  <tbody>
    ...
    <tr>
      <td style="text-align:center; background:#a1a1a1" colspan="2"><img src="https://i.ibb.co/n8JndbP/mobisoft.png" alt="mobisoft" width="120" style="width:105px;"/></td>
    </tr>
    ...
    <tr>
      ...
      <p style="text-align:left; color:#ccc; font-size:12px; float:right; font-family:Arial, sans-serif; line-height:0px;" >&copy;  <?= date('Y'); ?>  <strong>Mobisoft</strong>. All Rights Reserved.</p>
      </td>
    </tr>
